  ...
  return (
    ...
    >
      ...
      <div className="grid gap-8 px-8 py-10 md:px-10 md:py-12 lg:grid-cols-[1.2fr_0.8fr]">
        <div>
          ...
          <Reveal delay={140}>
            <p className="mt-4 max-w-xl text-base leading-relaxed text-ink/60 md:text-lg">
              In 3–5 days, get a working adaptive UX prototype embedded into your product — designed to respond to real
              user behavior.
            </p>
          </Reveal>
          <Reveal delay={200}>
        ...
        <Reveal delay={220} className="self-start">
          <div
            style={{
              border: "0.5px solid rgba(49, 107, 255, 0.22)",
              boxShadow: "0 0 24px rgba(49, 107, 255, 0.10)",
            }}
            className="rounded-2xl bg-white/90 p-6 backdrop-blur"
          >
